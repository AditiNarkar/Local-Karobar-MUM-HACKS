...
const UpdatePage = () => {
  ...
  const getKarobarURL = "http://localhost:5001/api/karobarData"
      ...
      <div className="view-page">
        ...
        <button className="upload-button2"
          onClick={async (e) => {
            ...
            const editMyKarobarURL = "http://localhost:5001/api/saveEditMyKarobar"
            ...
            if (data.status === 200) {
              ...
              if (gallery || newprofilephoto) {
                ...
                const editMyKarobarPhotosURL = "http://localhost:5001/api/saveEditMyKarobarPhotos"
